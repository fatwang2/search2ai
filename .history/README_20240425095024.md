...
| `SEARXNG_BASE_URL` | No       | 如选serper必填，6个月免费额度2500次，注册地址 https://search2ai.online/serper如选searXNG必填，填写自建searXNG服务域名，例如：https://search.xxx.xxx。（须包含https/http且末尾不含/）`xxx` |                                                                                  |
